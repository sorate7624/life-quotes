...
export var App = function () {
    ...
    }), quote = _a[0], setQuote = _a[1];
    var _b = useState(''), translatedText = _b[0], setTranslatedText = _b[1];
    var _c = useState(''), translatedAuthor = _c[0], setTranslatedAuthor = _c[1];
    useEffect(function () {
        var fetchQuote = function () { return __awaiter(void 0, void 0, void 0, function () {
            var quoteData;
    ...
    useEffect(function () {
        quote.translateText.then(function (text) {
            setTranslatedText(text);
        });
    }, [quote.translateText]);
    useEffect(function () {
        quote.translateAuthor.then(function (author) {
